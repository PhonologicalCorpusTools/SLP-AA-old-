...
The configuration and hand for which you are selecting the handshape can be changed on the top bar. For example, if you want to select a predefined handshape for
