...
predefined_handshape_mapping = {
    ...
    ('_', 'O', '<', 'E', 'E',
     ...
     '<', '2', 'E', 'E', 'E',
     '=', '3', 'F', 'F', 'F',
     '=', '4', 'F', 'F', 'F'): 'closed-double-modified-G',
