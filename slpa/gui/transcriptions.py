...
predefined_handshape_mapping = {
    Handshape1.canonical: '1',
    Handshape5.canonical: '5',
    HandshapeA.canonical: 'A',
    HandshapeB1.canonical: 'B1',
    HandshapeB2.canonical: 'B2',
    HandshapeBase.canonical: 'base',
    HandshapeC.canonical: 'C',
    HandshapeO.canonical: 'O',
    HandshapeS.canonical: 'S',

    HandshapeExtendedA.canonical: 'extended-A',
    HandshapeClosedAIndex.canonical: 'closed-A-index',
    HandshapeOpenA.canonical: 'open-A',
    HandshapeModifiedA.canonical: 'modified-A',

    HandshapeBentB.canonical: 'bent-B',
    HandshapeClawedExtendedB.canonical: 'clawed-extended-B',
    HandshapeContractedB.canonical: 'contracted-B',
    HandshapeCrookedExtendedB.canonical: 'crooked-extended-B',
    HandshapeExtendedB.canonical: 'extended-B',
    HandshapeSlantedExtendedB.canonical: 'slanted-extended-B',
    HandshapeBentExtendedB.canonical: 'bent-extended-B',

    HandshapeClawedC.canonical: 'clawed-C',
    HandshapeClawedSpreadC.canonical: 'clawed-spread-C',
    HandshapeCrookedC.canonical: 'crooked-C',
    HandshapeContractedC.canonical: 'contracted-C',
    HandshapeExtendedC.canonical: 'extended-C',
    HandshapeFlatC.canonical: 'flat-C',
    HandshapeCIndex.canonical: 'C-index',
    HandshapeDoubleCIndex.canonical: 'double-C-index',
    HandshapeSpreadC.canonical: 'spread-C',
    HandshapeSpreadExtendedC.canonical: 'spread-extended-C',

    HandshapeD.canonical: 'D',
    HandshapePartiallyBentD.canonical: 'partially-bent-D',
    HandshapeClosedBentD.canonical: 'closed-bent-D',
    HandshapeModifiedD.canonical: 'modified-D',

    HandshapeE.canonical: 'E',
    HandshapeOpenE.canonical: 'open-E',

    HandshapeF.canonical: 'F',
    HandshapeClawedF.canonical: 'clawed-F',
    HandshapeCoveredF.canonical: 'covered-F',
    HandshapeSlantedF.canonical: 'slanted-F',
    HandshapeFlatF.canonical: 'flat-F',
    HandshapeFlatOpenF.canonical: 'flat-open-F',
    HandshapeFlatClawedF.canonical: 'flat-clawed-F',
    HandshapeAdductedF.canonical: 'adducted-F',
    HandshapeOffsetF.canonical: 'offset-F',
    HandshapeOpenF.canonical: 'open-F',

    HandshapeG.canonical: 'G',
    HandshapeClosedG.canonical: 'closed-G',
    HandshapeDoubleModifiedG.canonical: 'double-modified-G',
    HandshapeClosedDoubleModifiedG.canonical: 'closed-double-modified-G',
    HandshapeModifiedG.canonical: 'modified-G',

    HandshapeI.canonical: 'I',
    HandshapeBentCombinedIPlusOne.canonical: 'bent-combined-I+1',
    HandshapeBentI.canonical: 'bent-I',
    HandshapeClawedI.canonical: 'clawed-I',
    HandshapeCombinedIPlusOne.canonical: 'combined-I+1',
    HandshapeCombinedILY.canonical: 'combined-ILY',
    HandshapeCombinedIPlusA.canonical: 'combined-I+A',
    HandshapeFlatCombinedIPlusOne.canonical: 'flat-combined-I+1',

    HandshapeK.canonical: 'K',
    HandshapeExtendedK.canonical: 'extended-K',

    HandshapeL.canonical: 'L',
    HandshapeBentL.canonical: 'bent-L',
    HandshapeBentThumbL.canonical: 'thumb-L',
    HandshapeClawedL.canonical: 'clawed-L',
    HandshapeContractedL.canonical: 'contracted-L',
    HandshapeDoubleContractedL.canonical: 'double-contracted-L',
    HandshapeCrookedL.canonical: 'crooked-L',

    HandshapeM.canonical: 'M',
    HandshapeFlatM.canonical: 'flat-M',

    HandshapeN.canonical: 'N',

    HandshapeCoveredO.canonical: 'covered-O',
    HandshapeFlatO.canonical: 'flat-O',
    HandshapeOIndex.canonical: 'O-index',
    HandshapeModifiedO.canonical: 'modified-O',
    HandshapeOffsetO.canonical: 'offset-O',
    HandshapeOpenSpreadO.canonical: 'open-spread-O',
    HandshapeOpenOIndex.canonical: 'open-O-index',

    HandshapeR.canonical: 'R',
    HandshapeBentR.canonical: 'bent-R',
    HandshapeExtendedR.canonical: 'extended-R',

    HandshapeT.canonical: 'T',
    HandshapeCoveredT.canonical: 'covered-T',
    ...
    HandshapeContractedUIndex.canonical: 'contracted-U-index',
    HandshapeCrookedU.canonical: 'crooked-U',
    HandshapeExtendedU.canonical: 'extended-U',

    HandshapeV.canonical: 'V',
    HandshapeBentV.canonical: 'bent-V',
    HandshapeBentExtendedV.canonical: 'bent-extended-V',
    HandshapeClawedV.canonical: 'clawed-V',
    HandshapeClawedExtendedV.canonical: 'clawed-extended-V',
    HandshapeClosedV.canonical: 'closed-V',
    HandshapeCrookedV.canonical: 'crooked-V',
    HandshapeCrookedExtendedV.canonical: 'crooked-extended-V',
    HandshapeSlantedV.canonical: 'slanted-V',

    HandshapeW.canonical: 'W',
    HandshapeClawedW.canonical: 'clawed-W',
    HandshapeClosedW.canonical: 'closed-W',
    HandshapeCrookedW.canonical: 'crooked-W',

    HandshapeX.canonical: 'X',
    HandshapeExtendedX.canonical: 'extended-X',
    HandshapeClosedX.canonical: 'closed-X',

    HandshapeY.canonical: 'Y',
    HandshapeCombinedYAndMiddle.canonical: 'combined-Y&middle',
    HandshapeModifiedY.canonical: 'modified-Y',

    HandshapeBent1.canonical: 'bent-1',
    HandshapeBentOffset1.canonical: 'bent-offset-1',
    HandshapeClawed1.canonical: 'clawed-1',
    HandshapeCrooked1.canonical: 'crooked-1',

    Handshape3.canonical: '3',
    HandshapeClawed3.canonical: 'clawed-3',
    HandshapeContracted3.canonical: 'contracted-3',

    Handshape4.canonical: '4',
    HandshapeBent4.canonical: 'bent-4',
    HandshapeClawed4.canonical: 'clawed-4',
    HandshapeCrooked4.canonical: 'crooked-4',
    HandshapeSlanted4.canonical: 'slanted-4',

    HandshapeBent5.canonical: 'bent-5',
    HandshapeBentMidfinger5.canonical: 'bent-midfinger-5',
    HandshapeClawed5.canonical: 'clawed-5',
    HandshapeContracted5.canonical: 'contracted-5',
    HandshapeRelaxedContracted5.canonical: 'relaxed-contracted-5',
    HandshapeCrooked5.canonical: 'crooked-5',
    HandshapeCrookedSlanted5.canonical: 'crooked-slanted-5',
    HandshapeModified5.canonical: 'modified-5',
    HandshapeSlanted5.canonical: 'slanted-5',

    Handshape6.canonical: '6',

    Handshape8.canonical: '8',
    HandshapeCovered8.canonical: 'covered-8',
    HandshapeExtended8.canonical: 'extended-8',
    HandshapeOpen8.canonical: 'open-8',
    HandshapeMiddleFinger.canonical: 'middle-finger'
}


class TranscriptionLayout(QVBoxLayout):
    updateSignal = Signal(bool)
...
class TranscriptionInfo(QGridLayout):
    ...
    def __init__(self, coder=None, lastUpdated=None):
        ...
        if self._coder and self._lastUpdated:
            ...
            self.coderLineEdit.textChanged.connect(self.updateCoder)
            self.lastUpdatedLineEdit = QLineEdit(str(self._lastUpdated))
            self.lastUpdatedLineEdit.textChanged.connect(self.updateLastUpdated)
...
class TranscriptionConfigTab(QWidget):
    ...
    def __init__(self, number, view_only=False):
        ...
        self.hand1Transcription.updateSignal.connect(self.emitUpdateSignal)
        self.configLayout.addLayout(self.hand1Transcription, 0, 0)
        self.hand2Transcription = TranscriptionLayout(view_only, hand=2)
        self.hand2Transcription.updateSignal.connect(self.emitUpdateSignal)
    ...
    def emitUpdateSignal(self, value):
